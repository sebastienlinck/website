	...
	<body>
		...
		<div id="page">
			...
			<nav>
				...
				<ul>
					<li><a href="accueil"><img class="icon" src="./img/home.svg" alt="icon home" width="32" height="32"><span class="icon-text">Accueil</span></a></li>
					<li><a href="enseignements"><img class="icon" src="./img/school.svg" alt="icon school" width="32" height="32"><span class="icon-text">Enseignements</span></a></li>
					<li>
						<div class="ssmenu expand">
							<span class="titremenu"><img class="icon" src="./img/computer.svg" alt="icon computer" width="32" height="32"><span class="icon-text">Recherche</span><img class="icon" src="./img/small-arrow-bottom.svg" alt="icon arrow bottom" width="32" height="32"></span>
						</div>
						<ul>       
					...
					<li><a href="publications"><img class="icon" src="./img/book.svg" alt="icon book" width="32" height="32"><span class="icon-text">Publications</span></a></li>
					<li><a href="contact"><img class="icon" src="./img/mail.svg" alt="icon mail" width="32" height="32"><span class="icon-text">Contact</span></a></li>
				</ul>				
			</nav>			
			<main id="container">
